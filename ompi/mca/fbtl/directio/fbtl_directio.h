...
mca_fbtl_directio_component_file_query (ompio_file_t *file, int *priority);
int mca_fbtl_directio_component_file_unquery (ompio_file_t *file);

int mca_fbtl_directio_module_init (ompio_file_t *file);
int mca_fbtl_directio_module_finalize (ompio_file_t *file);
...
ssize_t mca_fbtl_directio_preadv (ompio_file_t *file );
ssize_t mca_fbtl_directio_pwritev (ompio_file_t *file );
ssize_t mca_fbtl_directio_ipreadv (ompio_file_t *file,
                               ompi_request_t *request);
ssize_t mca_fbtl_directio_ipwritev (ompio_file_t *file,
                                ompi_request_t *request);
